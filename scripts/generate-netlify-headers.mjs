...
const common = `Cross-Origin-Opener-Policy: same-origin; Cross-Origin-Embedder-Policy: credentialless; Permissions-Policy: camera=(), microphone=(), geolocation=(); default-src 'self'; script-src ${scriptSrc}; style-src 'self'; connect-src ${connectSrc}; img-src 'self' data:; font-src 'self' data:; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report; report-to csp-endpoint`;
const login = `Cross-Origin-Opener-Policy: same-origin; Cross-Origin-Embedder-Policy: credentialless; Permissions-Policy: camera=(), microphone=(), geolocation=(); default-src 'self'; script-src 'self' https://identity.netlify.com https://netlify-rum.netlify.app; style-src 'self' 'unsafe-inline'; connect-src 'self' https://identity.netlify.com; img-src 'self' data: https://identity.netlify.com; frame-src 'self' https://identity.netlify.com; font-src 'self' data:; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report; report-to csp-endpoint`;
const beginner = `Cross-Origin-Opener-Policy: same-origin; Cross-Origin-Embedder-Policy: credentialless; Permissions-Policy: camera=(), microphone=(), geolocation=(); default-src 'self'; script-src 'self' https://identity.netlify.com; style-src 'self'; connect-src 'self' https://identity.netlify.com; img-src 'self' data: https://identity.netlify.com; font-src 'self' data:; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report; report-to csp-endpoint`;
const vm = `Cross-Origin-Opener-Policy: same-origin; Cross-Origin-Embedder-Policy: credentialless; Permissions-Policy: camera=(), microphone=(), geolocation=(); default-src 'self'; script-src ${scriptSrc}; style-src 'self'; connect-src ${connectSrc}; img-src 'self' data:; font-src 'self'; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report; report-to csp-endpoint`;
const developer = `Cross-Origin-Opener-Policy: same-origin; Cross-Origin-Embedder-Policy: credentialless; Permissions-Policy: camera=(), microphone=(), geolocation=(); default-src 'self'; script-src ${scriptSrc}; style-src 'self'; connect-src ${connectSrc}; img-src 'self' data:; font-src 'self'; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'; report-uri /api/csp-report; report-to csp-endpoint`;
