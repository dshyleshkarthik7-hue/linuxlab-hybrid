...
const ISO_BASE = 'https://linuxterminal-iso.dshyleshkarthik7.workers.dev/';
const VIRT_PROFILE: Profile = { name: 'Alpine Virt 3.24.1', memoryMiB: 256, cdrom: `${ISO_BASE}?image=virt`, policy: 'virt', expectedGuest: 'alpine' };
const DEVELOPER_PROFILE: Profile = { name: 'Developer Alpine v1.0.0', memoryMiB: 1024, cdrom: `${ISO_BASE}?image=developer`, policy: 'developer', expectedGuest: 'alpine' };
