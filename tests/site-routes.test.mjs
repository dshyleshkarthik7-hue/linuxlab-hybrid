...
assert.ok(progress.includes('<script src="/progress.js"></script><script type="module" src="./progress.js"></script>'), 'Progress ledger must load before progress UI module');
