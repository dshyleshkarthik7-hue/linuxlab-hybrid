...
assert.match(runtime, /removeEventListener\('resize', this\.handleResize\)/);
assert.match(runtime, /removeEventListener\('orientationchange', this\.handleOrientationChange\)/);
